...
public:
    ...
    std::set<OpenTrip*, EtdComp> convertExpiredUnmatchedReqsToOpenTrips(std::set<Request*, ReqComp> * pUnmatchedRequests, const time_t currTime, std::set<const int> * pFlexDepReqIndices);
