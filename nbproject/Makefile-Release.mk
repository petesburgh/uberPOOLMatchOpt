...
${OBJECTDIR}/AssignedRoute.o: AssignedRoute.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AssignedRoute.o AssignedRoute.cpp

${OBJECTDIR}/AssignedTrip.o: AssignedTrip.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AssignedTrip.o AssignedTrip.cpp
...
${OBJECTDIR}/DataContainer.o: DataContainer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataContainer.o DataContainer.cpp
...
${OBJECTDIR}/Geofence.o: Geofence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geofence.o Geofence.cpp
...
${OBJECTDIR}/MultPickupSoln.o: MultPickupSoln.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MultPickupSoln.o MultPickupSoln.cpp

${OBJECTDIR}/MultiplePickupsModel.o: MultiplePickupsModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MultiplePickupsModel.o MultiplePickupsModel.cpp

${OBJECTDIR}/OpenTrip.o: OpenTrip.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OpenTrip.o OpenTrip.cpp
...
${OBJECTDIR}/Rider.o: Rider.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Rider.o Rider.cpp
...
${OBJECTDIR}/RouteEvent.o: RouteEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RouteEvent.o RouteEvent.cpp
...
${OBJECTDIR}/TripData.o: TripData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TripData.o TripData.cpp
